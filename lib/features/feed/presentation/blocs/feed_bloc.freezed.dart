...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( FeedFetched value)?  fetched,required TResult orElse(),}){
final _that = this;
switch (_that) {
case FeedFetched() when fetched != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( FeedFetched value)  fetched,}){
final _that = this;
switch (_that) {
case FeedFetched():
return fetched(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( FeedFetched value)?  fetched,}){
final _that = this;
switch (_that) {
case FeedFetched() when fetched != null:
return fetched(_that);case _:
...
class FeedFetched implements FeedEvent {
  const FeedFetched();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedFetched);
}
...
@override
String toString() {
  return 'FeedState.loaded(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $FeedStateCopyWith<$Res> {
...
class _Error implements FeedState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $FeedStateCopyWith<$Res> {
